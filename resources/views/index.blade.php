...
<head>
	...
	<link href="{{ asset('template/audio/style_audio.css') }}" rel="stylesheet">
	...
	<div class="content-wraper">
		...
		<div id="gallery" class="page-content-scroll">
			...
			<div class="">
				...
				<iframe src="https://akad.wedding/gallery-DianAdenWedding" style="position:absolute; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:1;">
		...
		<div id="more" class="page-content-scroll">
			<div class="top-bg">
				<amp-img alt="Wedding Images" src="{{ asset('template/assets/img/bg-rose.png') }}" width="195" height="256"
					layout="responsive">
				</amp-img>
			</div>
			<div class="bottom-bg">
			...
			<div class="content center-text">
				...
				<amp-img alt="Wedding Images" src="{{ asset('template/assets/img/covid-icon.png') }}" width="356" height="111"
					layout="responsive">
				</amp-img>
			</div>
